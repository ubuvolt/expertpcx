...
class EbayPriceTrackingController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('admin', 'delete', 'ebayTrackingView'),
    ...
    public function actionCreate() {
        $model = new EbayPriceTracking;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['EbayPriceTracking'])) {
            $model->attributes = $_POST['EbayPriceTracking'];
            if ($model->save())
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('EbayPriceTracking');
    ...
    public function actionAdmin() {
        $model = new EbayPriceTracking('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['EbayPriceTracking']))
            $model->attributes = $_GET['EbayPriceTracking'];
     ...
     * @return EbayPriceTracking the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = EbayPriceTracking::model()->findByPk($id);
        if ($model === null)
     ...
     * @param EbayPriceTracking $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'ebay-price-tracking-form') {
