...
/**
 * This is the model class for table "log_ebay_item".
 *
 ...
 */
class LogEbayItem extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, itemID, data_time, field_name, old_value, new_value', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return LogEbayItem the static model class
	 */
