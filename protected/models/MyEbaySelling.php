...
class MyEbaySelling extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('itemID, shopName, startTime, listingDuration, listingType, shippingProfileID, returnProfileID, paymentProfileID', 'length', 'max'=>128),
