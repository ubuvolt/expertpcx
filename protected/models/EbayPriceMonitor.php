 ...
 */
class EbayPriceMonitor extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, product, seller, url, price', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return EbayPriceMonitor the static model class
	 */
