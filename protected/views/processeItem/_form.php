...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'activeList'); ?>
		<?php echo $form->textField($model,'activeList',array('size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'activeList'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'sellerProfiles'); ?>
		<?php echo $form->textArea($model,'sellerProfiles',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'sellerProfiles'); ?>
	</div>
