...
$this->menu=array(
	...
	array('label'=>'Update EbayItem', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete EbayItem', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage EbayItem', 'url'=>array('admin')),
);
?>

<h1>View EbayItem #<?php echo $model->id; ?></h1>
