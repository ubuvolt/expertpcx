...
<div class="view view_cms">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('shippDet_weightMinor')); ?>:</b>
	<?php echo CHtml::encode($data->shippDet_weightMinor); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('shippDet_shippingServiceCost')); ?>:</b>
	<?php echo CHtml::encode($data->shippDet_shippingServiceCost); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sp_shippingProfileID')); ?>:</b>
	<?php echo CHtml::encode($data->sp_shippingProfileID); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sp_shippingProfileName')); ?>:</b>
	<?php echo CHtml::encode($data->sp_shippingProfileName); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sp_returnProfileID')); ?>:</b>
	<?php echo CHtml::encode($data->sp_returnProfileID); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sp_returnProfileName')); ?>:</b>
	<?php echo CHtml::encode($data->sp_returnProfileName); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sp_paymentProfileID')); ?>:</b>
	<?php echo CHtml::encode($data->sp_paymentProfileID); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sp_paymentProfileName')); ?>:</b>
	<?php echo CHtml::encode($data->sp_paymentProfileName); ?>
	<br />
